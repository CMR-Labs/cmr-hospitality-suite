    ...
    <main style={{ fontFamily: "'Inter', sans-serif", minHeight: "100vh", backgroundColor: "#F9F7F4", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 24px" }}>
        <div style={{ backgroundColor: "white", border: "1px solid #e5e0d8", padding: "48px", width: "100%", maxWidth: "440px", textAlign: "center" }}>
          {status === "loading" && (
            <>
              <div style={{ width: "48px", height: "48px", border: "3px solid #E5E7EB", borderTop: "3px solid #1B2D5B", borderRadius: "50%", margin: "0 auto 24px", animation: "spin 1s linear infinite" }} />
              <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "22px", fontWeight: 700, color: "#1B2D5B", margin: "0 0 8px" }}>Verifying your email...</h1>
